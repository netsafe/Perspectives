...
var Pers_whitelist_dialog = {
	...
	confirm_add : function() {
		...
		HostContainerInterface.setProp("extensions.perspectives.whitelist",whitelist);
	...
	remove_from_whitelist : function() {
		try {
			...
			var host = window.gBrowser.currentURI.host;
			var old_whitelist = HostContainerInterface.getProp("extensions.perspectives.whitelist").split(",");
			var new_whitelist = [];
			...
			HostContainerInterface.setProp("extensions.perspectives.whitelist",new_whitelist.join(","));
